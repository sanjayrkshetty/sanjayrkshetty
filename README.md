...
- Research on adversarial ML and LLM security vulnerabilities
- Public write-ups on AI threat modelling (starting Q2 2026)
- Portfolio of pre-sales security consulting templates
...
| Repo | What it is |
|------|-----------|
| [`ai-security-notes`](https://github.com/sanjayrkshetty/ai-security-notes) | Research notes on adversarial ML and LLM security — updated as I read |
| [`sisa-presales-toolkit`](https://github.com/sanjayrkshetty/sisa-presales-toolkit) | Pre-sales security templates: discovery, scoping, proposals, STRIDE |
...
> *Building in public takes discipline. These repos are my forcing function.*